...
const PublicFormBySlugPage = lazy(() => import('./pages/PublicFormBySlugPage.jsx'));
...
export default function App() {
  return (
    <Suspense fallback={<LoadingState label="Cargando página…" />}>
      ...
      {/* Compat AppThesis: iframe de /public/forms/:slug */}
      <Route path="/public/forms/:slug" element={<PublicFormBySlugPage />} />
